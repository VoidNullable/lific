...
export function GET() {
  ...
  const body = [
    "# Lific",
    "",
    "> A free, self-hosted issue tracker built for coding agents. Single Rust binary, SQLite storage, a built-in MCP server with 31 tools, REST API, CLI, and web UI.",
    "",
